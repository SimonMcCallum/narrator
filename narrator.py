...
async def audioloop(talking, prevTime, save, newshot, victory, script, screen, win, new):
    ...
    if (not talking and newshot and not victory):
        newshot = False
        print("🎙️ David says:")
        print(analysis)
        talking = True
...
async def VideoLoop(talking, prevTime, save, newshot, victory, script, screen, win, new):
    if(talking):
            prevTime = time.time()
...
def main():
    ...
    asyncio.run(VideoLoop(talking, prevTime, save, newshot, victory, script, screen, win, new))
    asyncio.run(audioloop(talking, prevTime, save, newshot, victory, script, screen, win, new))
